 ...
 */
class VerySimpleLinkCollection_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function view()
    {
        ...
        $viewHelper = new VerySimpleLinkCollection_Util_View($this->serviceManager);
        ...
        $modelHelper = new VerySimpleLinkCollection_Util_Model($this->serviceManager);
