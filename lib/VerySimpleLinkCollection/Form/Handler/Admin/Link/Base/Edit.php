 ...
 */
class VerySimpleLinkCollection_Form_Handler_Admin_Link_Base_Edit extends VerySimpleLinkCollection_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeCapital = 'Link';
        $this->objectTypeLower = 'link';
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            $modelHelper = new VerySimpleLinkCollection_Util_Model($this->view->getServiceManager());
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the link yet as other items are required which must be created before!'));
        ...
        if (count($this->listFields) > 0) {
            $helper = new VerySimpleLinkCollection_Util_ListEntries($this->view->getServiceManager());
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                        if ($this->mode == 'create') {
                            $message = $this->__('Done! Link created.');
                        } else {
                            $message = $this->__('Done! Link updated.');
                        }
                        break;
            case 'delete':
                        $message = $this->__('Done! Link deleted.');
                        break;
            default:
                        $message = $this->__('Done! Link updated.');
                        break;
    ...
    public function applyAction(array $args = array())
    {
        ...
        try {
            ...
            $workflowHelper = new VerySimpleLinkCollection_Util_Workflow($this->view->getServiceManager());
