 ...
 */
class VerySimpleLinkCollection_TaggedObjectMeta_Base_VerySimpleLinkCollection extends Tag_AbstractTaggedObjectMeta
{
    /**
     * Constructor.
     *
    ...
    function __construct($objectId, $areaId, $module, $urlString = null, Zikula_ModUrl $urlObject = null)
    {
        ...
        $objectType = isset($urlArgs['ot']) ? $urlArgs['ot'] : 'link';
