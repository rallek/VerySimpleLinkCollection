 ...
 */
class VerySimpleLinkCollection_Block_Base_Moderation extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('VerySimpleLinkCollection:ModerationBlock:', 'Block title::');
    }
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('VerySimpleLinkCollection:ModerationBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        $workflowHelper = new VerySimpleLinkCollection_Util_Workflow($this->serviceManager);
