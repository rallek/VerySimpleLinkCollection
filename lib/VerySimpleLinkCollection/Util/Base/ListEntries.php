 ...
 */
class VerySimpleLinkCollection_Util_Base_ListEntries extends Zikula_AbstractBase
{
    /**
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'link':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForLink();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries.
     */
    public function getWorkflowStateEntriesForLink()
    {
        $states = array();
