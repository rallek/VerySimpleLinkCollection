 ...
 */
class VerySimpleLinkCollection_Util_Base_Controller extends Zikula_AbstractBase
{
    /**
     * Returns an array of all allowed object types in VerySimpleLinkCollection.
     *
    ...
    public function getObjectTypes($context = '', $args = array())
    {
        ...
        $allowedObjectTypes[] = 'link';
    
        return $allowedObjectTypes;
    }

    /**
     * Returns the default object type in VerySimpleLinkCollection.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, actionHandler, block, contentType, util).
     * @param array  $args    Additional arguments.
     *
