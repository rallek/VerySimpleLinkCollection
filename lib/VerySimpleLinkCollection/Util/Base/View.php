 ...
 */
class VerySimpleLinkCollection_Util_Base_View extends Zikula_AbstractBase
{
    /**
    ...
    {
        $extParams = array();
        $hasAdminAccess = SecurityUtil::checkPermission('VerySimpleLinkCollection:' . ucwords($objectType) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
