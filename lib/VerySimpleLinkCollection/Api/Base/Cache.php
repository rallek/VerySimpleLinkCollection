 ...
 */
class VerySimpleLinkCollection_Api_Base_Cache extends Zikula_AbstractApi
{
    /**
    ...
    public function clearItemCache(array $args = array())
    {
        ...
        $view = Zikula_View::getInstance('VerySimpleLinkCollection');
        ...
        $cacheIds[] = 'VerySimpleLinkCollection/user/main'; // main function
        $cacheIds[] = 'VerySimpleLinkCollection/user/view/' . $objectType; // view function (list views)
        $cacheIds[] = 'VerySimpleLinkCollection/user/display/' . $objectType . '|' . $instanceId; // display function (detail views)
