 ...
 */
class VerySimpleLinkCollection_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function getlinks()
    {
        ...
        if (in_array('link', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Link:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'link')),
                             'text' => $this->__('Links'),
    ...
    public function encodeurl(array $args = array())
    {
        ...
        $routerFacade = new VerySimpleLinkCollection_RouterFacade();
        ...
        $modInfo = ModUtil::getInfoFromName('VerySimpleLinkCollection');
