 ...
 */
class VerySimpleLinkCollection_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('This plugin shows a list of links of the VerySimpleLinkCollection module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            $objectTypes['link'] = array('name' => $this->__('Links'));
        }
