 ...
 */
class VerySimpleLinkCollection_ContentType_Base_ItemList extends Content_AbstractContentType
{
    /**
    ...
    {
        return 'VerySimpleLinkCollection';
    }
    ...
    public function getTitle()
    {
        ...
        return __('VerySimpleLinkCollection list view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display list of VerySimpleLinkCollection objects.', $dom);
    }
    ...
    public function loadData(&$data)
    {
        ...
        $controllerHelper = new VerySimpleLinkCollection_Util_Controller($serviceManager);
        ...
        if (in_array($this->objectType, $this->categorisableObjectTypes)) {
            $idFields = ModUtil::apiFunc('VerySimpleLinkCollection', 'selection', 'getIdFields', array('ot' => $this->objectType));
            $this->catRegistries = ModUtil::apiFunc('VerySimpleLinkCollection', 'category', 'getAllPropertiesWithMainCat', array('ot' => $this->objectType, 'arraykey' => $idFields[0]));
            $this->catProperties = ModUtil::apiFunc('VerySimpleLinkCollection', 'category', 'getAllProperties', array('ot' => $this->objectType));
        }
    
        if (!isset($data['catIds'])) {
            $primaryRegistry = ModUtil::apiFunc('VerySimpleLinkCollection', 'category', 'getPrimaryProperty', array('ot' => $this->objectType));
    ...
    public function display()
    {
        ...
        $entityClass = 'VerySimpleLinkCollection_Entity_' . ucwords($this->objectType);
        $serviceManager = ServiceUtil::getManager();
        $entityManager = $serviceManager->getService('doctrine.entitymanager');
        $repository = $entityManager->getRepository($entityClass);
    
        // ensure that the view does not look for templates in the Content module (#218)
        $this->view->toplevelmodule = 'VerySimpleLinkCollection';
    
        $this->view->setCaching(Zikula_View::CACHE_ENABLED);
        // set cache id
        $component = 'VerySimpleLinkCollection:' . ucwords($this->objectType) . ':';
        $instance = '::';
        ...
        if (in_array($this->objectType, $this->categorisableObjectTypes)) {
            if (is_array($this->catIds) && count($this->catIds) > 0) {
                $qb = ModUtil::apiFunc('VerySimpleLinkCollection', 'category', 'buildFilterClauses', array('qb' => $qb, 'ot' => $this->objectType, 'catids' => $this->catIds));
            }
        }
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/VerySimpleLinkCollection/templates/plugins');
