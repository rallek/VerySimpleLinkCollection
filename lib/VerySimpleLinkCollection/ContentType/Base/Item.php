 ...
 */
class VerySimpleLinkCollection_ContentType_Base_Item extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('VerySimpleLinkCollection detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single VerySimpleLinkCollection object.', $dom);
    }
    ...
    public function display()
    {
        if ($this->id != null && !empty($this->displayMode)) {
            return ModUtil::func('VerySimpleLinkCollection', 'external', 'display', $this->getDisplayArguments());
        }
