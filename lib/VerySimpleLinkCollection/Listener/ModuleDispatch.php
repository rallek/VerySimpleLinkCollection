 ...
 */
class VerySimpleLinkCollection_Listener_ModuleDispatch extends VerySimpleLinkCollection_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('VerySimpleLinkCollection', 'user', 'main'), 'text' => __('Link Text'));
    }
}
