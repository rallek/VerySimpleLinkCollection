 ...
 */
class VerySimpleLinkCollection_Listener_Base_User
{
    /**
    ...
    public static function delete(Zikula_Event $event)
    {
        ...
        $repo = $entityManager->getRepository('VerySimpleLinkCollection_Entity_Link');
        // delete all links created by this user
        $repo->deleteCreator($uid);
        // note you could also do: $repo->updateCreator($uid, 2);
        
        // set last editor to admin (2) for all links updated by this user
