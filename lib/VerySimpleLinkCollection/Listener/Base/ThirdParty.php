 ...
 */
class VerySimpleLinkCollection_Listener_Base_ThirdParty
{
    /**
    ...
    public static function contentGetTypes(Zikula_Event $event)
    {
        ...
        $types->add('VerySimpleLinkCollection_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('VerySimpleLinkCollection_ContentType_ItemList');
    }
}
