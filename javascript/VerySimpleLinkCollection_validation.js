...
function vslcReadDate(val, includeTime)
{
 ...
 */
function vslcAddCommonValidationRules(objectType, id)
{
    Validation.addAllThese([
        ['validate-nospace', Zikula.__('No spaces', 'module_verysimplelinkcollection_js'), function(val, elem) {
            var valStr;
