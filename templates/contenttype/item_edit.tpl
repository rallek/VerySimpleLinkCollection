...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='verySimpleLinkCollectionObjectType' __text='Object type'}
            {verysimplelinkcollectionObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='verySimpleLinkCollectionObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {verysimplelinkcollectionItemSelector id='id' group='data' objectType=$objectType}
    </div>
