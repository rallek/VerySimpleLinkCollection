...
/**
 * The verysimplelinkcollectionTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_verysimplelinkcollectionTemplateSelector($params, $view)
{
