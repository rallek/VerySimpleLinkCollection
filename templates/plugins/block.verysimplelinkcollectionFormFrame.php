...
/**
 * The verysimplelinkcollectionFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_verysimplelinkcollectionFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('VerySimpleLinkCollection_Form_Plugin_FormFrame', $params, $content);
