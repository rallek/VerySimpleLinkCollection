...
/**
 * The verysimplelinkcollectionObjectState modifier displays the name of a given object's workflow state.
 * Examples:
 *    {$item.workflowState|verysimplelinkcollectionObjectState}       {* with visual feedback *}
 *    {$item.workflowState|verysimplelinkcollectionObjectState:false} {* no ui feedback *}
 *
 ...
 */
function smarty_modifier_verysimplelinkcollectionObjectState($state = 'initial', $uiFeedback = true)
{
