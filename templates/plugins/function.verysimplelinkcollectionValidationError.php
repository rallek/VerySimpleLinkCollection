...
/**
 * The verysimplelinkcollectionValidationError plugin returns appropriate (and multilingual)
 ...
 */
function smarty_function_verysimplelinkcollectionValidationError($params, $view)
{
    $id = $params['id'];
    $class = $params['class'];
