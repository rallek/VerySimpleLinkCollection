...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="{$baseurl}modules/VerySimpleLinkCollection/javascript/VerySimpleLinkCollection_editFunctions.js"></script>
    </head>
    <body>
        ...
        /* <![CDATA[ */
            ...
            document.observe('dom:loaded', function() {
                vslcCloseWindowFromInside('{{$idPrefix}}', {{if $commandName eq 'create'}}{{$itemId}}{{else}}0{{/if}});
            });
        /* ]]> */
        </script>
    </body>
