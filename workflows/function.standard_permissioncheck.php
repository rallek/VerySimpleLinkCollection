 ...
 */
function VerySimpleLinkCollection_workflow_standard_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
 ...
 */
function VerySimpleLinkCollection_workflow_standard_gettextstrings()
{
    return array(
